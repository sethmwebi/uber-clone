    ...
    <SafeAreaView>
      ...
      <View style={{ flexDirection: "row" }}>
        <Pressable
          ...
          style={{
            backgroundColor: transportationMode === TransportationMode.BICYCLING ? "#3fc060" : "white",
            margin: 10,
            padding: 10,
            borderWidth: 1,
            borderColor: "gray",
        ...
        <Pressable
          ...
          style={{
            backgroundColor: transportationMode === TransportationMode.DRIVING ? "#3fc060" : "white",
            margin: 10,
            padding: 10,
            borderWidth: 1,
            borderColor: "gray",
